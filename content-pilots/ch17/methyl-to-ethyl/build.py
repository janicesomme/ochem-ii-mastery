...
def joined(n,size,cue=False):
 ...
 # Ethyl rotates as an intact piece; its pre-existing C-C bond length is retained.
...
body='''<header><p class="eyebrow">NO FEAR OCHEM · CHAPTER 17 · V2 — STANDARD REAGENT DRAWINGS</p><h1>Same move.<br>A bigger carbon piece.</h1><p>You already know how to add methyl. Now keep the same joining move and bring two carbons instead of one.</p></header><section><h2>The rule stays small</h2><p><strong>Attach the carbon holding MgBr to the aldehyde carbon. Keep the rest of the incoming piece together.</strong></p><p>This sheet asks for product connections. Draw on paper first; then open the skeletal answer.</p></section>'''
last=None
for q in qs:
 if q['id']=='3':
...
(P/'methyl-to-ethyl-v2-standard-reagents.html').write_text('<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Same move, methyl to ethyl — v2</title><style>'+css+'</style><main>'+body+'</main></html>')
